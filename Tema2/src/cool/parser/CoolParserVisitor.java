...
public interface CoolParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code funcFeature}
	 * labeled alternative in {@link CoolParser#feature}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncFeature(CoolParser.FuncFeatureContext ctx);
	/**
	 * Visit a parse tree produced by the {@code varFeature}
	 * labeled alternative in {@link CoolParser#feature}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarFeature(CoolParser.VarFeatureContext ctx);
	/**
